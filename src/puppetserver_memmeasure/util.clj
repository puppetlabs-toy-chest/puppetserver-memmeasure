   ...
   "params" {"configured_environment" environment-name
             ...
             "facts" (str "%7B%22name%22%3A%22" node-name "%22%2C"
                          ...
                          (-> jruby-puppet-config
                              ...
                              str)
                          "%22%2C"
                          "%22fake_domain%22%3A%22pgtomcat.mycompany.org%22%2C"
                          "%22function%22%3A%22app%22%2C"
                          "%22group%22%3A%22pgtomcat%22%2C"
                          "%22whereami%22%3A%22portland%22%2C"
                          "%22stage%22%3A%22prod%22%2C"
